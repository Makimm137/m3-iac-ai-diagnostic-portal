    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 overflow-x-hidden">
      ...
      <div className="w-full relative h-44 overflow-hidden print:hidden border-b border-slate-200">
        ...
        <div className="relative h-full flex items-center justify-center">
          <h2 className="text-white text-3xl md:text-5xl font-extrabold tracking-[0.3em] px-8 text-center drop-shadow-2xl">
            {l.systemTitle}
          </h2>
        </div>
      </div>
      ...
      <main className="max-w-[1400px] mx-auto p-8 space-y-8">
        ...
        <div className="flex items-center justify-between print:hidden">
          <h1 className="text-3xl font-bold tracking-tight uppercase">{n.caseList}</h1>
          <button className="bg-slate-900 text-white px-6 py-2 rounded-none font-normal flex items-center gap-2 hover:bg-black transition-all">
        ...
        <div className="bg-white border border-slate-200 p-8 rounded-none print:hidden">
          ...
          <div className="flex flex-col items-center mt-10 space-y-4">
             <button 
                ...
                className="bg-slate-900 text-white px-16 py-3.5 rounded-none font-normal flex items-center gap-3 hover:bg-black transition-all disabled:opacity-20 border-none uppercase tracking-[0.3em] text-[13px]"
              ...
              <div className="col-span-12 lg:col-span-7 p-10 border-r border-slate-100 space-y-8">
                ...
                <div className="space-y-6 pt-6 border-t border-slate-100">
                  <div className="flex items-center gap-2 text-primary">
                    ...
                    <h3 className="font-bold text-[14px] tracking-widest uppercase">{l.clinicalRecommendation}</h3>
                  </div>
                  
                  <div className="bg-red-50 border border-red-100 p-8 rounded-none">
                    <div className="flex items-center gap-3 mb-3 text-red-700">
                      <span className="material-symbols-outlined text-xl">report</span>
                      <span className="text-[16px] font-bold tracking-widest uppercase">{l.riskWarning}</span>
                    </div>
                    <p className="text-red-900 text-[14px] font-normal leading-relaxed">{currentAnalysis?.recommendation}</p>
                  </div>
              ...
              <div className="col-span-12 lg:col-span-5 p-10 bg-slate-50/10 space-y-10 print:col-span-12 border-l border-slate-100">
                ...
                <div>
                  <div className="flex justify-between items-center mb-8">
                    ...
                    <span className="bg-red-600 text-white text-[9px] font-normal px-3 py-1 rounded-none tracking-widest uppercase">High Risk</span>
                  </div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { label: l.minDistance, value: currentAnalysis?.minDistance, alert: true },
                      ...
                      { label: l.riskScore, value: currentAnalysis?.riskScore, alert: true },
                      { label: l.injuryProbability, value: currentAnalysis?.injuryProbability, alert: true }
                    ].map((item, i) => (
                      <div key={i} className="flex justify-between items-center border-b border-slate-200 pb-3 last:border-0">
                        <span className="text-[12px] text-slate-400 font-normal uppercase tracking-widest">{item.label}</span>
                        <span className={`text-[13px] font-normal tracking-tight ${item.alert ? 'text-red-600' : 'text-slate-900'}`}>
                          {item.value}
                        </span>
                      </div>
                    ))}
                ...
                <button 
                  ...
                  className="w-full bg-slate-900 text-white py-4 rounded-none font-normal flex items-center justify-center gap-4 hover:bg-black transition-all shadow-none mt-12 print:hidden uppercase text-[13px] tracking-[0.4em] active:translate-y-px border-none"
                >
